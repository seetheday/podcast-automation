...
* Change Codex CLI and VS Code from API key to Pro account
* Set up Codex environment for repo
* Set up Codex code review in Github
* Add sample original .wav files to repo
* Add music file to repo
